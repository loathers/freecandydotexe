...
new ActionSource(familiar, () => (have($effect(FreeRun_templateObject3 || (FreeRun_templateObject3 = FreeRun_taggedTemplateLiteral(["Ode to Booze"])))) || getSongCount() < getSongLimit()) && couldRunaway() ? getRemainingRunaways() : 0, Macro.step("runaway"), {
...
}), new ActionSource(template_string_$skill(FreeRun_templateObject45 || (FreeRun_templateObject45 = FreeRun_taggedTemplateLiteral(["Show your boring familiar pictures"]))), () => {
  if (have(template_string_$item(FreeRun_templateObject46 || (FreeRun_templateObject46 = FreeRun_taggedTemplateLiteral(["familiar scrapbook"]))))) {
  ...
  return 0;
}, Macro.skill(template_string_$skill(FreeRun_templateObject47 || (FreeRun_templateObject47 = FreeRun_taggedTemplateLiteral(["Show your boring familiar pictures"])))), {
  equipmentRequirements: () => new Requirement([], {
...
function juneCleave() {
  if (property_get("_juneCleaverFightsLeft") <= 0) {
    ...
    withProperty("recoveryScript", "", () => {
      adventureMacro((0,external_kolmafia_namespaceObject.myInebriety)() <= (0,external_kolmafia_namespaceObject.inebrietyLimit)() ? $location(lib_templateObject21 || (lib_templateObject21 = lib_taggedTemplateLiteral(["Noob Cave"]))) : $location(lib_templateObject22 || (lib_templateObject22 = lib_taggedTemplateLiteral(["Drunken Stupor"]))), Macro.abort());

      if (["Poetic Justice", "Lost and Found"].includes(property_get("lastEncounter"))) {
        lib_uneffect($effect(lib_templateObject23 || (lib_templateObject23 = lib_taggedTemplateLiteral(["Beaten Up"]))));
      }
    });
...
function getEffectWeight() {
  if (!cache.effectWeight) {
    cache.effectWeight = utils_sum(Object.entries((0,external_kolmafia_namespaceObject.myEffects)()).map(_ref => {
      ...
      return (0,external_kolmafia_namespaceObject.numericModifier)(effect, "Familiar Weight") && duration >= (0,external_kolmafia_namespaceObject.myAdventures)();
    }), _ref4 => {
      var effect = _ref4.effect;
      return (0,external_kolmafia_namespaceObject.numericModifier)(effect, "Familiar Weight");
    });
  }
...
function fightOutfit() {
  ...
  if (getString("freecandy_trickOutfit")) {
    ...
    if (!adventureFamiliars.includes(trickFamiliar()) && !stasisFamiliars.has(trickFamiliar()) && have(template_string_$item(outfit_templateObject40 || (outfit_templateObject40 = outfit_taggedTemplateLiteral(["tiny stillsuit"]))))) {
      forceEquips.push(template_string_$item(outfit_templateObject41 || (outfit_templateObject41 = outfit_taggedTemplateLiteral(["tiny stillsuit"]))));
    }

    var stasisData = stasisFamiliars.get((0,external_kolmafia_namespaceObject.myFamiliar)());

    if (stasisData) {
      if (stasisData.baseRate + actionRateBonus() < 1 && getFoldGroup(template_string_$item(outfit_templateObject42 || (outfit_templateObject42 = outfit_taggedTemplateLiteral(["Loathing Legion helicopter"])))).some(foldable => have(foldable))) {
        forceEquips.push(template_string_$item(outfit_templateObject43 || (outfit_templateObject43 = outfit_taggedTemplateLiteral(["Loathing Legion helicopter"]))));
      }
    }

    var weightValue = stasisData ? //action rate times weight per lb
    utils_clamp(stasisData.baseRate + actionRateBonus() + (forceEquips.includes(template_string_$item(outfit_templateObject44 || (outfit_templateObject44 = outfit_taggedTemplateLiteral(["Loathing Legion helicopter"])))) && !(0,external_kolmafia_namespaceObject.haveEquipped)(template_string_$item(outfit_templateObject45 || (outfit_templateObject45 = outfit_taggedTemplateLiteral(["Loathing Legion helicopter"])))) ? 0.25 : 0), 0, 1) * stasisData.meatPerLb : adventureFamiliars.includes(trickFamiliar()) ? // https://www.desmos.com/calculator/y8iszw6rfk
    ...
    maximizeCached(["".concat(Math.round(weightValue * 100) / 100, " Familiar Weight")].concat(outfit_toConsumableArray(have(template_string_$item(outfit_templateObject46 || (outfit_templateObject46 = outfit_taggedTemplateLiteral(["SongBoom\u2122 BoomBox"])))) ? ["0.25 Meat Drop"] : []), ["0.01 Item Drop"], maximizeTargets), {
      forceEquip: forceEquips,
      bonusEquip: bonusEquips,
      preventSlot: $slots(outfit_templateObject47 || (outfit_templateObject47 = outfit_taggedTemplateLiteral(["buddy-bjorn, crown-of-thrones"]))),
      preventEquip: bjornalikeToUse === template_string_$item(outfit_templateObject48 || (outfit_templateObject48 = outfit_taggedTemplateLiteral(["Buddy Bjorn"]))) ? template_string_$items(outfit_templateObject49 || (outfit_templateObject49 = outfit_taggedTemplateLiteral(["Crown of Thrones"]))) : template_string_$items(outfit_templateObject50 || (outfit_templateObject50 = outfit_taggedTemplateLiteral(["Buddy Bjorn"]))),
      useOutfitCaching: true
    });
    if (bjornalikeToUse && (0,external_kolmafia_namespaceObject.equippedItem)((0,external_kolmafia_namespaceObject.toSlot)(bjornalikeToUse)) === template_string_$item(outfit_templateObject51 || (outfit_templateObject51 = outfit_taggedTemplateLiteral(["none"])))) (0,external_kolmafia_namespaceObject.equip)((0,external_kolmafia_namespaceObject.toSlot)(bjornalikeToUse), bjornalikeToUse);
    if ((0,external_kolmafia_namespaceObject.haveEquipped)(template_string_$item(outfit_templateObject52 || (outfit_templateObject52 = outfit_taggedTemplateLiteral(["Buddy Bjorn"]))))) (0,external_kolmafia_namespaceObject.bjornifyFamiliar)(pickBjorn().familiar);
    if ((0,external_kolmafia_namespaceObject.haveEquipped)(template_string_$item(outfit_templateObject53 || (outfit_templateObject53 = outfit_taggedTemplateLiteral(["Crown of Thrones"]))))) (0,external_kolmafia_namespaceObject.enthroneFamiliar)(pickBjorn().familiar);
    if (type === "Spit Acid" && (0,external_kolmafia_namespaceObject.haveEquipped)(template_string_$item(outfit_templateObject54 || (outfit_templateObject54 = outfit_taggedTemplateLiteral(["Jurassic Parka"]))))) (0,external_kolmafia_namespaceObject.cliExecute)("parka dilophosaur");
  }
}

function snowSuit() {
  if (!have(template_string_$item(outfit_templateObject55 || (outfit_templateObject55 = outfit_taggedTemplateLiteral(["Snow Suit"])))) || property_get("_carrotNoseDrops") >= 3) return new Map([]);
  return new Map([[template_string_$item(outfit_templateObject56 || (outfit_templateObject56 = outfit_taggedTemplateLiteral(["Snow Suit"]))), getSaleValue(template_string_$item(outfit_templateObject57 || (outfit_templateObject57 = outfit_taggedTemplateLiteral(["carrot nose"])))) / 10]]);
}
...
function mayflowerBouquet() {
  ...
  if (!have(template_string_$item(outfit_templateObject58 || (outfit_templateObject58 = outfit_taggedTemplateLiteral(["Mayflower bouquet"])))) || property_get("_mayflowerDrops") >= 10) return new Map([]);
  var averageFlowerValue = getSaleValue.apply(void 0, outfit_toConsumableArray(template_string_$items(outfit_templateObject59 || (outfit_templateObject59 = outfit_taggedTemplateLiteral(["tin magnolia, upsy daisy, lesser grodulated violet, half-orchid, begpwnia"]))))) * Math.max(0.01, 0.5 - property_get("_mayflowerDrops") * 0.11);
  return new Map([[template_string_$item(outfit_templateObject60 || (outfit_templateObject60 = outfit_taggedTemplateLiteral(["Mayflower bouquet"]))), averageFlowerValue]]);
}

function pantsgiving() {
  var _foodPick$costOverrid, _foodPick$costOverrid2;

  if (!have(template_string_$item(outfit_templateObject61 || (outfit_templateObject61 = outfit_taggedTemplateLiteral(["Pantsgiving"]))))) return new Map();
  ...
  var fullnessValue = overallAdventureValue() * (lib_getAverageAdventures(foodPick.food) + 1 + (property_get("_fudgeSporkUsed") ? 3 : 0)) - ((_foodPick$costOverrid = (_foodPick$costOverrid2 = foodPick.costOverride) === null || _foodPick$costOverrid2 === void 0 ? void 0 : _foodPick$costOverrid2.call(foodPick)) !== null && _foodPick$costOverrid !== void 0 ? _foodPick$costOverrid : (0,external_kolmafia_namespaceObject.mallPrice)(foodPick.food)) - (0,external_kolmafia_namespaceObject.mallPrice)(template_string_$item(outfit_templateObject62 || (outfit_templateObject62 = outfit_taggedTemplateLiteral(["Special Seasoning"])))) - (property_get("_fudgeSporkUsed") ? (0,external_kolmafia_namespaceObject.mallPrice)(template_string_$item(outfit_templateObject63 || (outfit_templateObject63 = outfit_taggedTemplateLiteral(["fudge spork"])))) : 0);
  var pantsgivingBonus = fullnessValue / (turns * 0.9);
  return new Map([[template_string_$item(outfit_templateObject64 || (outfit_templateObject64 = outfit_taggedTemplateLiteral(["Pantsgiving"]))), pantsgivingBonus]]);
}

function overallAdventureValue() {
  var bonuses = new Map([[template_string_$item(outfit_templateObject65 || (outfit_templateObject65 = outfit_taggedTemplateLiteral(["lucky gold ring"]))), 400], [template_string_$item(outfit_templateObject66 || (outfit_templateObject66 = outfit_taggedTemplateLiteral(["Mr. Cheeng's spectacles"]))), 250], [template_string_$item(outfit_templateObject67 || (outfit_templateObject67 = outfit_taggedTemplateLiteral(["pantogram pants"]))), property_get("_pantogramModifier").includes("Drops Items") ? 100 : 0], [template_string_$item(outfit_templateObject68 || (outfit_templateObject68 = outfit_taggedTemplateLiteral(["Mr. Screege's spectacles"]))), 180], [template_string_$item(outfit_templateObject69 || (outfit_templateObject69 = outfit_taggedTemplateLiteral(["bag of many confections"]))), getSaleValue.apply(void 0, outfit_toConsumableArray(template_string_$items(outfit_templateObject70 || (outfit_templateObject70 = outfit_taggedTemplateLiteral(["Polka Pop, BitterSweetTarts, Piddles"]))))) / 6]].concat(outfit_toConsumableArray(snowSuit()), outfit_toConsumableArray(mayflowerBouquet()), outfit_toConsumableArray(juneCleaver()), outfit_toConsumableArray(sweatpants())));
  ...
  }), number => number) + baseAdventureValue() + ((0,external_kolmafia_namespaceObject.haveEquipped)(template_string_$item(outfit_templateObject71 || (outfit_templateObject71 = outfit_taggedTemplateLiteral(["Buddy Bjorn"])))) || (0,external_kolmafia_namespaceObject.haveEquipped)(template_string_$item(outfit_templateObject72 || (outfit_templateObject72 = outfit_taggedTemplateLiteral(["Crown of Thrones"])))) ? riderValue(pickBjorn()) : 0);
...
var pantsgivingFoods = [{
  food: template_string_$item(outfit_templateObject73 || (outfit_templateObject73 = outfit_taggedTemplateLiteral(["glass of raw eggs"]))),
  costOverride: () => 0,
  canGet: () => have(template_string_$item(outfit_templateObject74 || (outfit_templateObject74 = outfit_taggedTemplateLiteral(["glass of raw eggs"]))))
}, {
  food: template_string_$item(outfit_templateObject75 || (outfit_templateObject75 = outfit_taggedTemplateLiteral(["Affirmation Cookie"]))),
  canGet: () => true
}, {
  food: template_string_$item(outfit_templateObject76 || (outfit_templateObject76 = outfit_taggedTemplateLiteral(["disco biscuit"]))),
  canGet: () => true
}, {
  food: template_string_$item(outfit_templateObject77 || (outfit_templateObject77 = outfit_taggedTemplateLiteral(["ice rice"]))),
  canGet: () => true
}, {
  food: template_string_$item(outfit_templateObject78 || (outfit_templateObject78 = outfit_taggedTemplateLiteral(["Tea, Earl Grey, Hot"]))),
  canGet: () => true
}, {
  food: template_string_$item(outfit_templateObject79 || (outfit_templateObject79 = outfit_taggedTemplateLiteral(["Dreadsylvanian stew"]))),
  costOverride: () => 10 / 20 * Math.max(getSaleValue(template_string_$item(outfit_templateObject80 || (outfit_templateObject80 = outfit_taggedTemplateLiteral(["electric Kool-Aid"])))), getSaleValue(template_string_$item(outfit_templateObject81 || (outfit_templateObject81 = outfit_taggedTemplateLiteral(["bottle of Bloodweiser"]))))),
  canGet: () => have(template_string_$item(outfit_templateObject82 || (outfit_templateObject82 = outfit_taggedTemplateLiteral(["Freddy Kruegerand"]))), 10) && (0,external_kolmafia_namespaceObject.isAccessible)($coinmaster(outfit_templateObject83 || (outfit_templateObject83 = outfit_taggedTemplateLiteral(["The Terrified Eagle Inn"])))) && (0,external_kolmafia_namespaceObject.myLevel)() >= 20
}, {
  food: template_string_$item(outfit_templateObject84 || (outfit_templateObject84 = outfit_taggedTemplateLiteral(["FantasyRealm turkey leg"]))),
  costOverride: () => 0,
  canGet: () => {
    if (!have(template_string_$item(outfit_templateObject85 || (outfit_templateObject85 = outfit_taggedTemplateLiteral(["Rubee\u2122"]))), 100)) return false;
    if (!property_get("_frToday") && !property_get("frAlways")) return false;
    if (have(template_string_$item(outfit_templateObject86 || (outfit_templateObject86 = outfit_taggedTemplateLiteral(["FantasyRealm G. E. M."]))))) return true;
    ...
    return have(template_string_$item(outfit_templateObject87 || (outfit_templateObject87 = outfit_taggedTemplateLiteral(["FantasyRealm G. E. M."]))));
  }
}];

var valuePantsgivingFood = foodChoice => {
  var _foodChoice$costOverr, _foodChoice$costOverr2;

  return lib_getAverageAdventures(foodChoice.food) * overallAdventureValue() - ((_foodChoice$costOverr = (_foodChoice$costOverr2 = foodChoice.costOverride) === null || _foodChoice$costOverr2 === void 0 ? void 0 : _foodChoice$costOverr2.call(foodChoice)) !== null && _foodChoice$costOverr !== void 0 ? _foodChoice$costOverr : (0,external_kolmafia_namespaceObject.mallPrice)(foodChoice.food));
};
...
function getPantsgivingFood() {
  ...
  if (!cache.pantsgivingFood) {
    cache.pantsgivingFood = pantsgivingFoods.filter(x => have(x.food) || x.canGet()).reduce((a, b) => valuePantsgivingFood(a) > valuePantsgivingFood(b) ? a : b);
  }
...
function baseAdventureValue() {
  if (cache.baseAdventureValue === undefined) {
    cache.baseAdventureValue = 1 / 5 * (3 * sumNumbers(Object.entries((0,external_kolmafia_namespaceObject.outfitTreats)(bestOutfit())).map(_ref5 => {
    ...
    })) * (have(template_string_$familiar(outfit_templateObject88 || (outfit_templateObject88 = outfit_taggedTemplateLiteral(["Trick-or-Treating Tot"])))) ? 1.6 : 0) + 1 / 5 * getSaleValue(template_string_$item(outfit_templateObject89 || (outfit_templateObject89 = outfit_taggedTemplateLiteral(["huge bowl of candy"])))) + (have(template_string_$familiar(outfit_templateObject90 || (outfit_templateObject90 = outfit_taggedTemplateLiteral(["Trick-or-Treating Tot"])))) ? 4 * 0.2 * getSaleValue(template_string_$item(outfit_templateObject91 || (outfit_templateObject91 = outfit_taggedTemplateLiteral(["Prunets"])))) : 0));
  }
...
function bestOutfit() {
  ...
  Object.entries((0,external_kolmafia_namespaceObject.outfitTreats)(cache.bestOutfit)).forEach(_ref9 => {
    var _ref10 = outfit_slicedToArray(_ref9, 1),
        candy = _ref10[0];
...
function meatOutfit() {
  ...
  new Requirement(["1000 Meat Drop"], {
    bonusEquip: new Map([[template_string_$item(outfit_templateObject92 || (outfit_templateObject92 = outfit_taggedTemplateLiteral(["lucky gold ring"]))), 400], [template_string_$item(outfit_templateObject93 || (outfit_templateObject93 = outfit_taggedTemplateLiteral(["Mr. Cheeng's spectacles"]))), 250], [template_string_$item(outfit_templateObject94 || (outfit_templateObject94 = outfit_taggedTemplateLiteral(["pantogram pants"]))), property_get("_pantogramModifier").includes("Drops Items") ? 100 : 0], [template_string_$item(outfit_templateObject95 || (outfit_templateObject95 = outfit_taggedTemplateLiteral(["Mr. Screege's spectacles"]))), 180], [template_string_$item(outfit_templateObject96 || (outfit_templateObject96 = outfit_taggedTemplateLiteral(["bag of many confections"]))), getSaleValue.apply(void 0, outfit_toConsumableArray(template_string_$items(outfit_templateObject97 || (outfit_templateObject97 = outfit_taggedTemplateLiteral(["Polka Pop, BitterSweetTarts, Piddles"]))))) / 6]].concat(outfit_toConsumableArray(snowSuit()), outfit_toConsumableArray(mayflowerBouquet()), outfit_toConsumableArray(juneCleaver()), [[template_string_$item(outfit_templateObject98 || (outfit_templateObject98 = outfit_taggedTemplateLiteral(["mafia thumb ring"]))), 0.04 * overallAdventureValue()]], outfit_toConsumableArray(bjornalike ? new Map([[bjornalike, riderValue(bjornFam)]]) : []))),
    preventEquip: template_string_$items(outfit_templateObject99 || (outfit_templateObject99 = outfit_taggedTemplateLiteral(["Buddy Bjorn, Crown of Thrones"]))).filter(bjorn => bjorn !== bjornalike),
    forceEquip: (0,external_kolmafia_namespaceObject.myInebriety)() > (0,external_kolmafia_namespaceObject.inebrietyLimit)() ? template_string_$items(outfit_templateObject100 || (outfit_templateObject100 = outfit_taggedTemplateLiteral(["Drunkula's wineglass"]))) : []
  }).maximize();
  if ((0,external_kolmafia_namespaceObject.haveEquipped)(template_string_$item(outfit_templateObject101 || (outfit_templateObject101 = outfit_taggedTemplateLiteral(["Buddy Bjorn"]))))) (0,external_kolmafia_namespaceObject.bjornifyFamiliar)(bjornFam.familiar);else if ((0,external_kolmafia_namespaceObject.haveEquipped)(template_string_$item(outfit_templateObject102 || (outfit_templateObject102 = outfit_taggedTemplateLiteral(["Crown of Thrones"]))))) (0,external_kolmafia_namespaceObject.enthroneFamiliar)(bjornFam.familiar);
}

function bestBjornalike(existingForceEquips) {
  var bjornalikes = template_string_$items(outfit_templateObject103 || (outfit_templateObject103 = outfit_taggedTemplateLiteral(["Buddy Bjorn, Crown of Thrones"])));
  ...
  var goodRobortHats = template_string_$items(outfit_templateObject104 || (outfit_templateObject104 = outfit_taggedTemplateLiteral(["crumpled felt fedora"])));
  if ((0,external_kolmafia_namespaceObject.myClass)() === $class(_templateObject105 || (_templateObject105 = outfit_taggedTemplateLiteral(["Turtle Tamer"])))) goodRobortHats.push(template_string_$item(_templateObject106 || (_templateObject106 = outfit_taggedTemplateLiteral(["warbear foil hat"]))));
  if ((0,external_kolmafia_namespaceObject.numericModifier)(template_string_$item(_templateObject107 || (_templateObject107 = outfit_taggedTemplateLiteral(["shining star cap"]))), "Familiar Weight") === 10) goodRobortHats.push(template_string_$item(_templateObject108 || (_templateObject108 = outfit_taggedTemplateLiteral(["shining star cap"]))));

  if (have(template_string_$item(_templateObject109 || (_templateObject109 = outfit_taggedTemplateLiteral(["carpe"])))) && (!hasStrongLep || !goodRobortHats.some(hat => have(hat)))) {
    return template_string_$item(_templateObject110 || (_templateObject110 = outfit_taggedTemplateLiteral(["Crown of Thrones"])));
  }

  return template_string_$item(_templateObject111 || (_templateObject111 = outfit_taggedTemplateLiteral(["Buddy Bjorn"])));
}

var juneCleaverEV = null;

function juneCleaver() {
  if (!have(template_string_$item(_templateObject112 || (_templateObject112 = outfit_taggedTemplateLiteral(["June cleaver"])))) || property_get("_juneCleaverFightsLeft") > (0,external_kolmafia_namespaceObject.myAdventures)()) {
    return new Map();
  }
  ...
  return new Map([[template_string_$item(_templateObject113 || (_templateObject113 = outfit_taggedTemplateLiteral(["June cleaver"]))), juneCleaverEV / getInterval()]]);
}

function sweatpants() {
  if (!have(template_string_$item(_templateObject114 || (_templateObject114 = outfit_taggedTemplateLiteral(["designer sweatpants"]))))) return new Map();
  ...
  var bestPerfectDrink = template_string_$items(_templateObject115 || (_templateObject115 = outfit_taggedTemplateLiteral(["perfect cosmopolitan, perfect negroni, perfect dark and stormy, perfect mimosa, perfect old-fashioned, perfect paloma"]))).map(item => ({
    item: item,
  ...
  var splendidMartiniValuePerDrunk = (lib_getAverageAdventures(template_string_$item(_templateObject116 || (_templateObject116 = outfit_taggedTemplateLiteral(["splendid martini"])))) + 2) * VOA;
  var bonus = Math.max(perfectDrinkValuePerDrunk, splendidMartiniValuePerDrunk) * 2 / 25;
  return new Map([[template_string_$item(_templateObject117 || (_templateObject117 = outfit_taggedTemplateLiteral(["designer sweatpants"]))), bonus]]);
}
;// CONCATENATED MODULE: ./src/combat.ts
var src_combat_templateObject, src_combat_templateObject2, combat_templateObject3, combat_templateObject4, combat_templateObject5, combat_templateObject6, combat_templateObject7, combat_templateObject8, combat_templateObject9, combat_templateObject10, combat_templateObject11, combat_templateObject12, combat_templateObject13, combat_templateObject14, combat_templateObject15, combat_templateObject16, combat_templateObject17, combat_templateObject18, combat_templateObject19, combat_templateObject20, combat_templateObject21, combat_templateObject22;
    ...
    var _ret = function () {
      ...
      try {
        var _loop = function _loop() {
          ...
          bestZones.add(lib_maxBy(yellowray_toConsumableArray(extraLocations), l => {
...
function runBlocks() {
  ...
  try {
    while (hasBlocksRemaining() && nemesis()) {
      ...
      if (available()) {
        sendTo($locations(trickin_and_treatin_templateObject35 || (trickin_and_treatin_templateObject35 = trickin_and_treatin_taggedTemplateLiteral(["The Toxic Teacups, The Oasis, The Deep Dark Jungle, The Bubblin' Caldera, The Sleazy Back Alley"]))));
      }
    }
  } finally {
...
/******/ 	var __webpack_exports__ = __webpack_require__(__webpack_require__.s = 1415);
