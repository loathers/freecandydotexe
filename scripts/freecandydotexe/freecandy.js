...
function overallAdventureValue() {
  ...
  }), number => number) + baseAdventureValue() + ((0,external_kolmafia_namespaceObject.haveEquipped)(template_string_$item(outfit_templateObject72 || (outfit_templateObject72 = outfit_taggedTemplateLiteral(["Buddy Bjorn"])))) || (0,external_kolmafia_namespaceObject.haveEquipped)(template_string_$item(outfit_templateObject73 || (outfit_templateObject73 = outfit_taggedTemplateLiteral(["Crown of Thrones"])))) ? bjornValue(pickBjorn()) : 0);
...
function meatOutfit() {
  ...
  new Requirement(["1000 Meat Drop"], {
    bonusEquip: new Map([[template_string_$item(_templateObject93 || (_templateObject93 = outfit_taggedTemplateLiteral(["lucky gold ring"]))), 400], [template_string_$item(_templateObject94 || (_templateObject94 = outfit_taggedTemplateLiteral(["Mr. Cheeng's spectacles"]))), 250], [template_string_$item(_templateObject95 || (_templateObject95 = outfit_taggedTemplateLiteral(["pantogram pants"]))), property_get("_pantogramModifier").includes("Drops Items") ? 100 : 0], [template_string_$item(_templateObject96 || (_templateObject96 = outfit_taggedTemplateLiteral(["Mr. Screege's spectacles"]))), 180], [template_string_$item(_templateObject97 || (_templateObject97 = outfit_taggedTemplateLiteral(["bag of many confections"]))), getSaleValue.apply(void 0, outfit_toConsumableArray(template_string_$items(_templateObject98 || (_templateObject98 = outfit_taggedTemplateLiteral(["Polka Pop, BitterSweetTarts, Piddles"]))))) / 6]].concat(outfit_toConsumableArray(snowSuit()), outfit_toConsumableArray(mayflowerBouquet()), [[template_string_$item(_templateObject99 || (_templateObject99 = outfit_taggedTemplateLiteral(["mafia thumb ring"]))), 0.04 * overallAdventureValue()]], outfit_toConsumableArray(bjornalike ? new Map([[bjornalike, bjornValue(bjornFam)]]) : []))),
    preventEquip: template_string_$items(_templateObject100 || (_templateObject100 = outfit_taggedTemplateLiteral(["Buddy Bjorn, Crown of Thrones"]))).filter(bjorn => bjorn !== bjornalike),
    forceEquip: (0,external_kolmafia_namespaceObject.myInebriety)() > (0,external_kolmafia_namespaceObject.inebrietyLimit)() ? template_string_$items(_templateObject101 || (_templateObject101 = outfit_taggedTemplateLiteral(["Drunkula's wineglass"]))) : []
  }).maximize();
  if ((0,external_kolmafia_namespaceObject.haveEquipped)(template_string_$item(_templateObject102 || (_templateObject102 = outfit_taggedTemplateLiteral(["Buddy Bjorn"]))))) (0,external_kolmafia_namespaceObject.bjornifyFamiliar)(bjornFam.familiar);else if ((0,external_kolmafia_namespaceObject.haveEquipped)(template_string_$item(_templateObject103 || (_templateObject103 = outfit_taggedTemplateLiteral(["Crown of Thrones"]))))) (0,external_kolmafia_namespaceObject.enthroneFamiliar)(bjornFam.familiar);
}

function bestBjornalike(existingForceEquips) {
  var bjornalikes = template_string_$items(_templateObject104 || (_templateObject104 = outfit_taggedTemplateLiteral(["Buddy Bjorn, Crown of Thrones"])));
