...
function fightOutfit() {
  ...
  if (dist.property.getString("freecandy_trickOutfit")) {
    (0,external_kolmafia_.outfit)(dist.property.getString("freecandy_trickOutfit"));

    switch (type) {
      case "Kramco":
        (0,external_kolmafia_.equip)((0,dist.$slot)(outfit_templateObject17 || (outfit_templateObject17 = outfit_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(outfit_templateObject18 || (outfit_templateObject18 = outfit_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"]))));
        break;

      case "Voter":
        (0,external_kolmafia_.equip)((0,dist.$slot)(outfit_templateObject19 || (outfit_templateObject19 = outfit_taggedTemplateLiteral(["acc1"]))), (0,dist.$item)(outfit_templateObject20 || (outfit_templateObject20 = outfit_taggedTemplateLiteral(["\"I Voted!\" sticker"]))));
        if ((0,external_kolmafia_.myInebriety)() > (0,external_kolmafia_.inebrietyLimit)()) (0,external_kolmafia_.equip)((0,dist.$slot)(outfit_templateObject21 || (outfit_templateObject21 = outfit_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(outfit_templateObject22 || (outfit_templateObject22 = outfit_taggedTemplateLiteral(["Drunkula's wineglass"]))));
        break;

      case "Ghost":
        (0,external_kolmafia_.equip)((0,dist.$slot)(outfit_templateObject23 || (outfit_templateObject23 = outfit_taggedTemplateLiteral(["back"]))), (0,dist.$item)(outfit_templateObject24 || (outfit_templateObject24 = outfit_taggedTemplateLiteral(["protonic accelerator pack"]))));
        break;

      case "Digitize":
        if ((0,external_kolmafia_.myInebriety)() > (0,external_kolmafia_.inebrietyLimit)()) (0,external_kolmafia_.equip)((0,dist.$slot)(outfit_templateObject25 || (outfit_templateObject25 = outfit_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(outfit_templateObject26 || (outfit_templateObject26 = outfit_taggedTemplateLiteral(["Drunkula's wineglass"]))));
        break;
    }
  } else {
    ...
    var trickHat = trickHats.find(hat => (0,dist.have)(hat)) || (0,dist.$item)(outfit_templateObject27 || (outfit_templateObject27 = outfit_taggedTemplateLiteral(["beholed bedsheet"]))); //Just to stop it from being undefined

    var forceEquips = [];
    var bonusEquips = new Map([[(0,dist.$item)(outfit_templateObject28 || (outfit_templateObject28 = outfit_taggedTemplateLiteral(["lucky gold ring"]))), 400], [(0,dist.$item)(outfit_templateObject29 || (outfit_templateObject29 = outfit_taggedTemplateLiteral(["Mr. Cheeng's spectacles"]))), 250], [(0,dist.$item)(outfit_templateObject30 || (outfit_templateObject30 = outfit_taggedTemplateLiteral(["pantogram pants"]))), (0,dist.get)("_pantogramModifier").includes("Drops Items") ? 100 : 0], [(0,dist.$item)(outfit_templateObject31 || (outfit_templateObject31 = outfit_taggedTemplateLiteral(["Mr. Screege's spectacles"]))), 180], [(0,dist.$item)(outfit_templateObject32 || (outfit_templateObject32 = outfit_taggedTemplateLiteral(["bag of many confections"]))), dist.getSaleValue.apply(void 0, outfit_toConsumableArray((0,dist.$items)(outfit_templateObject33 || (outfit_templateObject33 = outfit_taggedTemplateLiteral(["Polka Pop, BitterSweetTarts, Piddles"]))))) / 6]].concat(outfit_toConsumableArray(snowSuit()), outfit_toConsumableArray(mayflowerBouquet()), outfit_toConsumableArray(pantsgiving())));

    switch (type) {
      case "Kramco":
        forceEquips.push((0,dist.$item)(outfit_templateObject34 || (outfit_templateObject34 = outfit_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"]))));
        break;

      case "Voter":
        forceEquips.push((0,dist.$item)(outfit_templateObject35 || (outfit_templateObject35 = outfit_taggedTemplateLiteral(["\"I Voted!\" sticker"]))));
        if ((0,external_kolmafia_.myInebriety)() > (0,external_kolmafia_.inebrietyLimit)()) forceEquips.push((0,dist.$item)(outfit_templateObject36 || (outfit_templateObject36 = outfit_taggedTemplateLiteral(["Drunkula's wineglass"]))));
        break;

      case "Ghost":
        forceEquips.push((0,dist.$item)(outfit_templateObject37 || (outfit_templateObject37 = outfit_taggedTemplateLiteral(["protonic accelerator pack"]))));
        break;
      ...
      case "Digitize":
        if ((0,external_kolmafia_.myInebriety)() > (0,external_kolmafia_.inebrietyLimit)()) forceEquips.push((0,dist.$item)(outfit_templateObject38 || (outfit_templateObject38 = outfit_taggedTemplateLiteral(["Drunkula's wineglass"]))));
        break;
    }

    if ((0,dist.have)((0,dist.$item)(outfit_templateObject39 || (outfit_templateObject39 = outfit_taggedTemplateLiteral(["protonic accelerator pack"])))) && forceEquips.every(item => (0,external_kolmafia_.toSlot)(item) !== (0,dist.$slot)(outfit_templateObject40 || (outfit_templateObject40 = outfit_taggedTemplateLiteral(["back"])))) && (0,dist.get)("questPAGhost") === "unstarted" && (0,dist.get)("nextParanormalActivity") <= (0,external_kolmafia_.totalTurnsPlayed)()) forceEquips.push((0,dist.$item)(outfit_templateObject41 || (outfit_templateObject41 = outfit_taggedTemplateLiteral(["protonic accelerator pack"]))));

    if (trickFamiliar() === (0,dist.$familiar)(outfit_templateObject42 || (outfit_templateObject42 = outfit_taggedTemplateLiteral(["Reagnimated Gnome"])))) {
      forceEquips.push((0,dist.$item)(outfit_templateObject43 || (outfit_templateObject43 = outfit_taggedTemplateLiteral(["gnomish housemaid's kgnee"]))));

      if (!(0,dist.have)((0,dist.$item)(outfit_templateObject44 || (outfit_templateObject44 = outfit_taggedTemplateLiteral(["gnomish housemaid's kgnee"]))))) {
    ...
    if (stasisData) {
      if (stasisData.baseRate + actionRateBonus() < 1 && (0,dist.getFoldGroup)((0,dist.$item)(outfit_templateObject45 || (outfit_templateObject45 = outfit_taggedTemplateLiteral(["Loathing Legion helicopter"])))).some(foldable => (0,dist.have)(foldable))) {
        forceEquips.push((0,dist.$item)(outfit_templateObject46 || (outfit_templateObject46 = outfit_taggedTemplateLiteral(["Loathing Legion helicopter"]))));
      }
    }

    var weightValue = stasisData ? //action rate times weight per lb
    (0,dist.clamp)(stasisData.baseRate + actionRateBonus() + (forceEquips.includes((0,dist.$item)(outfit_templateObject47 || (outfit_templateObject47 = outfit_taggedTemplateLiteral(["Loathing Legion helicopter"])))) && !(0,external_kolmafia_.haveEquipped)((0,dist.$item)(outfit_templateObject48 || (outfit_templateObject48 = outfit_taggedTemplateLiteral(["Loathing Legion helicopter"])))) ? 0.25 : 0), 0, 1) * stasisData.meatPerLb : adventureFamiliars.includes(trickFamiliar()) ? //1.1 multiplier meant to account for linearization and weight estimates undervaluing gnome lbs
    ...
    (0,dist.maximizeCached)(["".concat(Math.round(weightValue * 100) / 100, " Familiar Weight")].concat(outfit_toConsumableArray((0,dist.have)((0,dist.$item)(outfit_templateObject49 || (outfit_templateObject49 = outfit_taggedTemplateLiteral(["SongBoom\u2122 BoomBox"])))) ? ["0.25 Meat Drop"] : []), ["0.01 Item Drop"]), {
      forceEquip: forceEquips,
      bonusEquip: bonusEquips,
      preventSlot: (0,dist.$slots)(outfit_templateObject50 || (outfit_templateObject50 = outfit_taggedTemplateLiteral(["buddy-bjorn, crown-of-thrones"]))),
      preventEquip: bjornalikeToUse === (0,dist.$item)(outfit_templateObject51 || (outfit_templateObject51 = outfit_taggedTemplateLiteral(["Buddy Bjorn"]))) ? (0,dist.$items)(outfit_templateObject52 || (outfit_templateObject52 = outfit_taggedTemplateLiteral(["Crown of Thrones"]))) : (0,dist.$items)(outfit_templateObject53 || (outfit_templateObject53 = outfit_taggedTemplateLiteral(["Buddy Bjorn"])))
    });
    if (bjornalikeToUse && (0,external_kolmafia_.equippedItem)((0,external_kolmafia_.toSlot)(bjornalikeToUse)) === (0,dist.$item)(outfit_templateObject54 || (outfit_templateObject54 = outfit_taggedTemplateLiteral(["none"])))) (0,external_kolmafia_.equip)((0,external_kolmafia_.toSlot)(bjornalikeToUse), bjornalikeToUse);
    if ((0,external_kolmafia_.haveEquipped)((0,dist.$item)(outfit_templateObject55 || (outfit_templateObject55 = outfit_taggedTemplateLiteral(["Buddy Bjorn"]))))) (0,external_kolmafia_.bjornifyFamiliar)(pickBjorn().familiar);
    if ((0,external_kolmafia_.haveEquipped)((0,dist.$item)(outfit_templateObject56 || (outfit_templateObject56 = outfit_taggedTemplateLiteral(["Crown of Thrones"]))))) (0,external_kolmafia_.enthroneFamiliar)(pickBjorn().familiar);
  }
}

function snowSuit() {
  if (!(0,dist.have)((0,dist.$item)(outfit_templateObject57 || (outfit_templateObject57 = outfit_taggedTemplateLiteral(["Snow Suit"])))) || (0,dist.get)("_carrotNoseDrops") >= 3) return new Map([]);
  return new Map([[(0,dist.$item)(outfit_templateObject58 || (outfit_templateObject58 = outfit_taggedTemplateLiteral(["Snow Suit"]))), (0,dist.getSaleValue)((0,dist.$item)(outfit_templateObject59 || (outfit_templateObject59 = outfit_taggedTemplateLiteral(["carrot nose"])))) / 10]]);
}
...
function mayflowerBouquet() {
  ...
  if (!(0,dist.have)((0,dist.$item)(outfit_templateObject60 || (outfit_templateObject60 = outfit_taggedTemplateLiteral(["Mayflower bouquet"])))) || (0,dist.get)("_mayflowerDrops") >= 10) return new Map([]);
  var averageFlowerValue = dist.getSaleValue.apply(void 0, outfit_toConsumableArray((0,dist.$items)(outfit_templateObject61 || (outfit_templateObject61 = outfit_taggedTemplateLiteral(["tin magnolia, upsy daisy, lesser grodulated violet, half-orchid, begpwnia"]))))) * Math.max(0.01, 0.5 - (0,dist.get)("_mayflowerDrops") * 0.11);
  return new Map([[(0,dist.$item)(outfit_templateObject62 || (outfit_templateObject62 = outfit_taggedTemplateLiteral(["Mayflower bouquet"]))), averageFlowerValue]]);
}
...
function pantsgiving() {
  ...
  var fullnessValue = overallAdventureValue() * ((0,dist.getAverageAdventures)(foodPick.food) + 1 + ((0,dist.get)("_fudgeSporkUsed") ? 3 : 0)) - (foodPick.costOverride ? foodPick.costOverride() : (0,external_kolmafia_.mallPrice)(foodPick.food)) - (0,external_kolmafia_.mallPrice)((0,dist.$item)(outfit_templateObject64 || (outfit_templateObject64 = outfit_taggedTemplateLiteral(["Special Seasoning"])))) - ((0,dist.get)("_fudgeSporkUsed") ? (0,external_kolmafia_.mallPrice)((0,dist.$item)(outfit_templateObject65 || (outfit_templateObject65 = outfit_taggedTemplateLiteral(["fudge spork"])))) : 0);
...
function overallAdventureValue() {
  var bonuses = new Map([[(0,dist.$item)(outfit_templateObject67 || (outfit_templateObject67 = outfit_taggedTemplateLiteral(["lucky gold ring"]))), 400], [(0,dist.$item)(outfit_templateObject68 || (outfit_templateObject68 = outfit_taggedTemplateLiteral(["Mr. Cheeng's spectacles"]))), 250], [(0,dist.$item)(outfit_templateObject69 || (outfit_templateObject69 = outfit_taggedTemplateLiteral(["pantogram pants"]))), (0,dist.get)("_pantogramModifier").includes("Drops Items") ? 100 : 0], [(0,dist.$item)(outfit_templateObject70 || (outfit_templateObject70 = outfit_taggedTemplateLiteral(["Mr. Screege's spectacles"]))), 180], [(0,dist.$item)(outfit_templateObject71 || (outfit_templateObject71 = outfit_taggedTemplateLiteral(["bag of many confections"]))), dist.getSaleValue.apply(void 0, outfit_toConsumableArray((0,dist.$items)(outfit_templateObject72 || (outfit_templateObject72 = outfit_taggedTemplateLiteral(["Polka Pop, BitterSweetTarts, Piddles"]))))) / 6]].concat(outfit_toConsumableArray(snowSuit()), outfit_toConsumableArray(mayflowerBouquet())));
  ...
  }), number => number) + baseAdventureValue() + ((0,external_kolmafia_.haveEquipped)((0,dist.$item)(outfit_templateObject73 || (outfit_templateObject73 = outfit_taggedTemplateLiteral(["Buddy Bjorn"])))) || (0,external_kolmafia_.haveEquipped)((0,dist.$item)(outfit_templateObject74 || (outfit_templateObject74 = outfit_taggedTemplateLiteral(["Crown of Thrones"])))) ? bjornValue(pickBjorn()) : 0);
...
var pantsgivingFoods = [{
  food: (0,dist.$item)(outfit_templateObject75 || (outfit_templateObject75 = outfit_taggedTemplateLiteral(["glass of raw eggs"]))),
  costOverride: () => 0,
  canGet: () => (0,dist.have)((0,dist.$item)(outfit_templateObject76 || (outfit_templateObject76 = outfit_taggedTemplateLiteral(["glass of raw eggs"]))))
}, {
  food: (0,dist.$item)(outfit_templateObject77 || (outfit_templateObject77 = outfit_taggedTemplateLiteral(["Affirmation Cookie"]))),
  canGet: () => true
}, {
  food: (0,dist.$item)(outfit_templateObject78 || (outfit_templateObject78 = outfit_taggedTemplateLiteral(["disco biscuit"]))),
  canGet: () => true
}, {
  food: (0,dist.$item)(outfit_templateObject79 || (outfit_templateObject79 = outfit_taggedTemplateLiteral(["ice rice"]))),
  canGet: () => true
}, {
  food: (0,dist.$item)(outfit_templateObject80 || (outfit_templateObject80 = outfit_taggedTemplateLiteral(["Tea, Earl Grey, Hot"]))),
  canGet: () => true
}, {
  food: (0,dist.$item)(outfit_templateObject81 || (outfit_templateObject81 = outfit_taggedTemplateLiteral(["Dreadsylvanian stew"]))),
  costOverride: () => 10 / 20 * Math.max((0,dist.getSaleValue)((0,dist.$item)(outfit_templateObject82 || (outfit_templateObject82 = outfit_taggedTemplateLiteral(["electric Kool-Aid"])))), (0,dist.getSaleValue)((0,dist.$item)(outfit_templateObject83 || (outfit_templateObject83 = outfit_taggedTemplateLiteral(["bottle of Bloodweiser"]))))),
  canGet: () => (0,dist.have)((0,dist.$item)(outfit_templateObject84 || (outfit_templateObject84 = outfit_taggedTemplateLiteral(["Freddy Kruegerand"]))), 10) && (0,external_kolmafia_.isAccessible)((0,dist.$coinmaster)(outfit_templateObject85 || (outfit_templateObject85 = outfit_taggedTemplateLiteral(["The Terrified Eagle Inn"])))) && (0,external_kolmafia_.myLevel)() >= 20
}, {
  food: (0,dist.$item)(outfit_templateObject86 || (outfit_templateObject86 = outfit_taggedTemplateLiteral(["FantasyRealm turkey leg"]))),
  costOverride: () => 0,
  canGet: () => {
    if (!(0,dist.have)((0,dist.$item)(outfit_templateObject87 || (outfit_templateObject87 = outfit_taggedTemplateLiteral(["Rubee\u2122"]))), 100)) return false;
    if (!(0,dist.get)("_frToday") && !(0,dist.get)("frAlways")) return false;
    if ((0,dist.have)((0,dist.$item)(outfit_templateObject88 || (outfit_templateObject88 = outfit_taggedTemplateLiteral(["FantasyRealm G. E. M."]))))) return true;
    (0,external_kolmafia_.visitUrl)("place.php?whichplace=realm_fantasy&action=fr_initcenter");
    (0,external_kolmafia_.runChoice)(1);
    return (0,dist.have)((0,dist.$item)(outfit_templateObject89 || (outfit_templateObject89 = outfit_taggedTemplateLiteral(["FantasyRealm G. E. M."]))));
  }
}];

var valuePantsgivingFood = foodChoice => (0,dist.getAverageAdventures)(foodChoice.food) * overallAdventureValue() - (foodChoice.costOverride ? foodChoice.costOverride() : (0,external_kolmafia_.mallPrice)(foodChoice.food));

function getPantsgivingFood() {
  if (cache.pantsgivingFood) {
    if (!(0,dist.have)(cache.pantsgivingFood.food) && !cache.pantsgivingFood.canGet()) {
      cache.pantsgivingFood = undefined;
    }
  }

  if (!cache.pantsgivingFood) {
    cache.pantsgivingFood = pantsgivingFoods.filter(x => (0,dist.have)(x.food) || x.canGet()).reduce((a, b) => valuePantsgivingFood(b) < valuePantsgivingFood(a) ? a : b);
  }
...
function baseAdventureValue() {
  if (cache.baseAdventureValue === undefined) {
    ...
    })) * ((0,dist.have)((0,dist.$familiar)(outfit_templateObject90 || (outfit_templateObject90 = outfit_taggedTemplateLiteral(["Trick-or-Treating Tot"])))) ? 1.6 : 0) + 1 / 5 * (0,dist.getSaleValue)((0,dist.$item)(outfit_templateObject91 || (outfit_templateObject91 = outfit_taggedTemplateLiteral(["huge bowl of candy"])))) + ((0,dist.have)((0,dist.$familiar)(outfit_templateObject92 || (outfit_templateObject92 = outfit_taggedTemplateLiteral(["Trick-or-Treating Tot"])))) ? 4 * 0.2 * (0,dist.getSaleValue)((0,dist.$item)(_templateObject93 || (_templateObject93 = outfit_taggedTemplateLiteral(["Prunets"])))) : 0));
  }
...
function meatOutfit() {
  ...
  new dist.Requirement(["1000 Meat Drop"], {
    bonusEquip: new Map([[(0,dist.$item)(_templateObject94 || (_templateObject94 = outfit_taggedTemplateLiteral(["lucky gold ring"]))), 400], [(0,dist.$item)(_templateObject95 || (_templateObject95 = outfit_taggedTemplateLiteral(["Mr. Cheeng's spectacles"]))), 250], [(0,dist.$item)(_templateObject96 || (_templateObject96 = outfit_taggedTemplateLiteral(["pantogram pants"]))), (0,dist.get)("_pantogramModifier").includes("Drops Items") ? 100 : 0], [(0,dist.$item)(_templateObject97 || (_templateObject97 = outfit_taggedTemplateLiteral(["Mr. Screege's spectacles"]))), 180], [(0,dist.$item)(_templateObject98 || (_templateObject98 = outfit_taggedTemplateLiteral(["bag of many confections"]))), dist.getSaleValue.apply(void 0, outfit_toConsumableArray((0,dist.$items)(_templateObject99 || (_templateObject99 = outfit_taggedTemplateLiteral(["Polka Pop, BitterSweetTarts, Piddles"]))))) / 6]].concat(outfit_toConsumableArray(snowSuit()), outfit_toConsumableArray(mayflowerBouquet()), [[(0,dist.$item)(_templateObject100 || (_templateObject100 = outfit_taggedTemplateLiteral(["mafia thumb ring"]))), 0.04 * overallAdventureValue()]], outfit_toConsumableArray(bjornalike ? new Map([[bjornalike, bjornValue(bjornFam)]]) : []))),
    preventEquip: (0,dist.$items)(_templateObject101 || (_templateObject101 = outfit_taggedTemplateLiteral(["Buddy Bjorn, Crown of Thrones"]))).filter(bjorn => bjorn !== bjornalike),
    forceEquip: (0,external_kolmafia_.myInebriety)() > (0,external_kolmafia_.inebrietyLimit)() ? (0,dist.$items)(_templateObject102 || (_templateObject102 = outfit_taggedTemplateLiteral(["Drunkula's wineglass"]))) : []
  }).maximize();
  if ((0,external_kolmafia_.haveEquipped)((0,dist.$item)(_templateObject103 || (_templateObject103 = outfit_taggedTemplateLiteral(["Buddy Bjorn"]))))) (0,external_kolmafia_.bjornifyFamiliar)(bjornFam.familiar);else if ((0,external_kolmafia_.haveEquipped)((0,dist.$item)(_templateObject104 || (_templateObject104 = outfit_taggedTemplateLiteral(["Crown of Thrones"]))))) (0,external_kolmafia_.enthroneFamiliar)(bjornFam.familiar);
}

function bestBjornalike(existingForceEquips) {
  var bjornalikes = (0,dist.$items)(_templateObject105 || (_templateObject105 = outfit_taggedTemplateLiteral(["Buddy Bjorn, Crown of Thrones"])));
  ...
  var goodRobortHats = (0,dist.$items)(_templateObject106 || (_templateObject106 = outfit_taggedTemplateLiteral(["crumpled felt fedora"])));
  if ((0,external_kolmafia_.myClass)() === (0,dist.$class)(_templateObject107 || (_templateObject107 = outfit_taggedTemplateLiteral(["Turtle Tamer"])))) goodRobortHats.push((0,dist.$item)(_templateObject108 || (_templateObject108 = outfit_taggedTemplateLiteral(["warbear foil hat"]))));
  if ((0,external_kolmafia_.numericModifier)((0,dist.$item)(_templateObject109 || (_templateObject109 = outfit_taggedTemplateLiteral(["shining star cap"]))), "Familiar Weight") === 10) goodRobortHats.push((0,dist.$item)(_templateObject110 || (_templateObject110 = outfit_taggedTemplateLiteral(["shining star cap"]))));

  if ((0,dist.have)((0,dist.$item)(_templateObject111 || (_templateObject111 = outfit_taggedTemplateLiteral(["carpe"])))) && (!hasStrongLep || !goodRobortHats.some(hat => (0,dist.have)(hat)))) {
    return (0,dist.$item)(_templateObject112 || (_templateObject112 = outfit_taggedTemplateLiteral(["Crown of Thrones"])));
  }

  return (0,dist.$item)(_templateObject113 || (_templateObject113 = outfit_taggedTemplateLiteral(["Buddy Bjorn"])));
}
...
function trick(trickMacro) {
  ...
  for (var i = 0; i <= 11; i++) {
    if (block().match(RegExp("whichhouse=".concat(i, ">[^>]*?house_d")))) {
      ...
      (0,external_kolmafia_.cliExecute)("mood execute");
      (0,external_kolmafia_.visitUrl)("choice.php?whichchoice=804&option=3&whichhouse=".concat(i, "&pwd"));
...
function fillPantsgivingFullness() {
  ...
  (0,external_kolmafia_.retrieveItem)(getPantsgivingFood().food);
  (0,external_kolmafia_.eat)(getPantsgivingFood().food);
}
      ...
      if ((0,dist.have)((0,dist.$item)(trickin_and_treatin_templateObject18 || (trickin_and_treatin_templateObject18 = trickin_and_treatin_taggedTemplateLiteral(["\"I Voted!\" sticker"])))) && canFightWanderers) {
        if ((0,external_kolmafia_.totalTurnsPlayed)() % 11 === 1 && (0,dist.get)("_voteFreeFights") < 3) {
          (function () {
            ...
            fightOutfit("Voter");
            var currentVotes = (0,dist.get)("_voteFreeFights");
            advMacroAA(determineDraggableZoneAndEnsureAccess(), trickMacro, () => (0,external_kolmafia_.totalTurnsPlayed)() % 11 === 1 && (0,dist.get)("_voteFreeFights") === currentVotes, fillPantsgivingFullness);
          })();
        }
      }
