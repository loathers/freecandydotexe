...
function estimateOutfitWeight() {
  if (!outfitWeightEstimate) {
    ...
    }) + ((0,libram__WEBPACK_IMPORTED_MODULE_3__.have)((0,libram__WEBPACK_IMPORTED_MODULE_3__.$familiar)(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["Temporal Riftlet"])))) ? 10 : 0) + ((0,libram__WEBPACK_IMPORTED_MODULE_3__.get)("_pantogramModifier").includes("Drops Items") && (0,libram__WEBPACK_IMPORTED_MODULE_3__.get)("_pantogramModifier").includes("Familiar Weight") ? 10 : 0);
  }
...
function getEffectWeight() {
  if (!effectWeight) {
    effectWeight = (0,_lib__WEBPACK_IMPORTED_MODULE_2__.sum)(Object.entries((0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.myEffects)()).map(function (_ref) {
      var _ref2 = _slicedToArray(_ref, 2),
          name = _ref2[0],
          duration = _ref2[1];
...
function fightOutfit() {
  ...
  var trickHat = trickHats.find(function (hat) {
    return (0,libram__WEBPACK_IMPORTED_MODULE_3__.have)(hat);
  }) || (0,libram__WEBPACK_IMPORTED_MODULE_3__.$item)(_templateObject21 || (_templateObject21 = _taggedTemplateLiteral(["beholed bedsheet"]))); //Just to stop it from being undefined

  var forceEquips = [];
  var bonusEquips = new Map([[(0,libram__WEBPACK_IMPORTED_MODULE_3__.$item)(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["garbage sticker"]))), 100], [(0,libram__WEBPACK_IMPORTED_MODULE_3__.$item)(_templateObject23 || (_templateObject23 = _taggedTemplateLiteral(["lucky gold ring"]))), 400], [(0,libram__WEBPACK_IMPORTED_MODULE_3__.$item)(_templateObject24 || (_templateObject24 = _taggedTemplateLiteral(["Mr. Cheeng's spectacles"]))), 250], [(0,libram__WEBPACK_IMPORTED_MODULE_3__.$item)(_templateObject25 || (_templateObject25 = _taggedTemplateLiteral(["pantogram pants"]))), (0,libram__WEBPACK_IMPORTED_MODULE_3__.get)("_pantogramModifier").includes("Drops Items") ? 100 : 0], [(0,libram__WEBPACK_IMPORTED_MODULE_3__.$item)(_templateObject26 || (_templateObject26 = _taggedTemplateLiteral(["Mr. Screege's spectacles"]))), 180], [(0,libram__WEBPACK_IMPORTED_MODULE_3__.$item)(_templateObject27 || (_templateObject27 = _taggedTemplateLiteral(["bag of many confections"]))), _lib__WEBPACK_IMPORTED_MODULE_2__.saleValue.apply(void 0, _toConsumableArray((0,libram__WEBPACK_IMPORTED_MODULE_3__.$items)(_templateObject28 || (_templateObject28 = _taggedTemplateLiteral(["Polka Pop, BitterSweetTarts, Piddles"]))))) / 6]].concat(_toConsumableArray(snowSuit()), _toConsumableArray(mayflowerBouquet()), _toConsumableArray(pantsgiving())));

  switch (type) {
    case "Kramco":
      forceEquips.push((0,libram__WEBPACK_IMPORTED_MODULE_3__.$item)(_templateObject29 || (_templateObject29 = _taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"]))));
      bonusEquips["delete"]((0,libram__WEBPACK_IMPORTED_MODULE_3__.$item)(_templateObject30 || (_templateObject30 = _taggedTemplateLiteral(["garbage sticker"]))));
      break;

    case "Voter":
      forceEquips.push((0,libram__WEBPACK_IMPORTED_MODULE_3__.$item)(_templateObject31 || (_templateObject31 = _taggedTemplateLiteral(["\"I Voted!\" sticker"]))));
      if ((_get = (0,libram__WEBPACK_IMPORTED_MODULE_3__.get)("_voteMonster")) !== null && _get !== void 0 && _get.maxMeat) bonusEquips["delete"]((0,libram__WEBPACK_IMPORTED_MODULE_3__.$item)(_templateObject32 || (_templateObject32 = _taggedTemplateLiteral(["garbage sticker"]))));
      break;

    case "Ghost":
      forceEquips.push((0,libram__WEBPACK_IMPORTED_MODULE_3__.$item)(_templateObject33 || (_templateObject33 = _taggedTemplateLiteral(["protonic accelerator pack"]))));
      break;
  ...
  if (forceEquips.every(function (item) {
    return (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.toSlot)(item) !== (0,libram__WEBPACK_IMPORTED_MODULE_3__.$slot)(_templateObject34 || (_templateObject34 = _taggedTemplateLiteral(["back"])));
  }) && (0,libram__WEBPACK_IMPORTED_MODULE_3__.get)("questPAGhost") === "unstarted" && (0,libram__WEBPACK_IMPORTED_MODULE_3__.get)("nextParanormalActivity") <= (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.totalTurnsPlayed)()) forceEquips.push((0,libram__WEBPACK_IMPORTED_MODULE_3__.$item)(_templateObject35 || (_templateObject35 = _taggedTemplateLiteral(["protonic accelerator pack"]))));
  var stasisData = stasisFamiliars.get((0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.myFamiliar)());

  if (stasisData) {
    if (stasisData.baseRate + actionRateBonus() < 1 && (0,libram__WEBPACK_IMPORTED_MODULE_3__.getFoldGroup)((0,libram__WEBPACK_IMPORTED_MODULE_3__.$item)(_templateObject36 || (_templateObject36 = _taggedTemplateLiteral(["Loathing Legion helicopter"])))).some(function (foldable) {
      return (0,libram__WEBPACK_IMPORTED_MODULE_3__.have)(foldable);
    })) {
      forceEquips.push((0,libram__WEBPACK_IMPORTED_MODULE_3__.$item)(_templateObject37 || (_templateObject37 = _taggedTemplateLiteral(["Loathing Legion helicopter"]))));
    }
  }
  ...
  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.haveEquipped)((0,libram__WEBPACK_IMPORTED_MODULE_3__.$item)(_templateObject46 || (_templateObject46 = _taggedTemplateLiteral(["Buddy Bjorn"]))))) (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.bjornifyFamiliar)((0,_bjorn__WEBPACK_IMPORTED_MODULE_1__.pickBjorn)().familiar);
  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.haveEquipped)((0,libram__WEBPACK_IMPORTED_MODULE_3__.$item)(_templateObject47 || (_templateObject47 = _taggedTemplateLiteral(["Crown of Thrones"]))))) (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.bjornifyFamiliar)((0,_bjorn__WEBPACK_IMPORTED_MODULE_1__.pickBjorn)().familiar);
}

function snowSuit() {
  if (!(0,libram__WEBPACK_IMPORTED_MODULE_3__.have)((0,libram__WEBPACK_IMPORTED_MODULE_3__.$item)(_templateObject48 || (_templateObject48 = _taggedTemplateLiteral(["Snow Suit"])))) || (0,libram__WEBPACK_IMPORTED_MODULE_3__.get)("_carrotNoseDrops") >= 3) return new Map([]);
  return new Map([[(0,libram__WEBPACK_IMPORTED_MODULE_3__.$item)(_templateObject49 || (_templateObject49 = _taggedTemplateLiteral(["Snow Suit"]))), (0,_lib__WEBPACK_IMPORTED_MODULE_2__.saleValue)((0,libram__WEBPACK_IMPORTED_MODULE_3__.$item)(_templateObject50 || (_templateObject50 = _taggedTemplateLiteral(["carrot nose"])))) / 10]]);
}
...
function mayflowerBouquet() {
  ...
  if (!(0,libram__WEBPACK_IMPORTED_MODULE_3__.have)((0,libram__WEBPACK_IMPORTED_MODULE_3__.$item)(_templateObject51 || (_templateObject51 = _taggedTemplateLiteral(["Mayflower bouquet"])))) || (0,libram__WEBPACK_IMPORTED_MODULE_3__.get)("_mayflowerDrops") >= 10) return new Map([]);
  var averageFlowerValue = _lib__WEBPACK_IMPORTED_MODULE_2__.saleValue.apply(void 0, _toConsumableArray((0,libram__WEBPACK_IMPORTED_MODULE_3__.$items)(_templateObject52 || (_templateObject52 = _taggedTemplateLiteral(["tin magnolia, upsy daisy, lesser grodulated violet, half-orchid, begpwnia"]))))) * Math.max(0.01, 0.5 - (0,libram__WEBPACK_IMPORTED_MODULE_3__.get)("_mayflowerDrops") * 0.11);
  return new Map([[(0,libram__WEBPACK_IMPORTED_MODULE_3__.$item)(_templateObject53 || (_templateObject53 = _taggedTemplateLiteral(["Mayflower bouquet"]))), averageFlowerValue]]);
}

function pantsgiving() {
  if (!(0,libram__WEBPACK_IMPORTED_MODULE_3__.have)((0,libram__WEBPACK_IMPORTED_MODULE_3__.$item)(_templateObject54 || (_templateObject54 = _taggedTemplateLiteral(["Pantsgiving"]))))) return new Map();
  ...
  var fullnessValue = (0,libram__WEBPACK_IMPORTED_MODULE_3__.get)("valueOfAdventure") * 6.5 - ((0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.mallPrice)((0,libram__WEBPACK_IMPORTED_MODULE_3__.$item)(_templateObject55 || (_templateObject55 = _taggedTemplateLiteral(["jumping horseradish"])))) + (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.mallPrice)((0,libram__WEBPACK_IMPORTED_MODULE_3__.$item)(_templateObject56 || (_templateObject56 = _taggedTemplateLiteral(["Special Seasoning"])))));
  var pantsgivingBonus = fullnessValue / (turns * 0.9);
  return new Map([[(0,libram__WEBPACK_IMPORTED_MODULE_3__.$item)(_templateObject57 || (_templateObject57 = _taggedTemplateLiteral(["Pantsgiving"]))), pantsgivingBonus]]);
}
